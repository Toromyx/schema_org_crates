...
pub fn to_token_stream(schema: &Schema) -> TokenStream {
	...
	let json_ls_0_16_feature_cfg_attribute =
		Feature::Name("json-ld_0_16".to_string()).as_cfg_attribute();
	let json_ld_0_16_mod = json_ld_0_16::to_token_stream(schema);
	quote!(
		#base
		...
		#json_ls_0_16_feature_cfg_attribute
		mod json_ld_0_16 {
			#json_ld_0_16_mod
		}
	)
